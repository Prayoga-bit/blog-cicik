...
<article class="flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
    {{-- Image --}}
    <a href="{{ $slug }}" class="relative block w-full h-64 overflow-hidden group">
        <img 
            alt="{{ $title }}" 
            loading="lazy" 
